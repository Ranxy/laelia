...
// RemoteImage fetches an attachment's bytes via downloadFile and renders them
// as an <img>. The object URL is revoked on unmount (and when the attachment
// changes) so we don't leak blobs. Two layout variants:
