...
export declare type LoginRequest = Message<"laelia.v1.LoginRequest"> & {
   ...
   *
   * @generated from field: laelia.v1.IdentityProviderContext idp_context = 5;
   */
...
/**
 * @generated from message laelia.v1.IdentityProviderContext
 */
export declare type IdentityProviderContext = Message<"laelia.v1.IdentityProviderContext"> & {
  /**
   * @generated from oneof laelia.v1.IdentityProviderContext.context
   */
  context: {
    /**
     * @generated from field: laelia.v1.OAuth2IdentityProviderContext oauth2_context = 1;
     */
...
/**
 * @generated from message laelia.v1.OAuth2IdentityProviderContext
 */
export declare type OAuth2IdentityProviderContext = Message<"laelia.v1.OAuth2IdentityProviderContext"> & {
  /**
...
/**
 * @generated from message laelia.v1.LoginResponse
 */
export declare type LoginResponse = Message<"laelia.v1.LoginResponse"> & {
  /**
   ...
   *
   * @generated from field: laelia.v1.User user = 4;
   */
  user?: User | undefined;
};
...
/**
 * @generated from message laelia.v1.LogoutRequest
 */
export declare type LogoutRequest = Message<"laelia.v1.LogoutRequest"> & {
};
...
export declare const AuthService: GenService<{
   ...
   *
   * @generated from rpc laelia.v1.AuthService.Login
   */
  login: {
    methodKind: "unary";
   ...
   * Permissions required: None
   *
   * @generated from rpc laelia.v1.AuthService.Logout
   */
  logout: {
    methodKind: "unary";
