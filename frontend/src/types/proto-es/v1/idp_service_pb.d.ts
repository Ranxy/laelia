...
/**
 * @generated from message laelia.v1.GetIdentityProviderRequest
 */
export declare type GetIdentityProviderRequest = Message<"laelia.v1.GetIdentityProviderRequest"> & {
  /**
...
/**
 * @generated from message laelia.v1.ListIdentityProvidersRequest
 */
export declare type ListIdentityProvidersRequest = Message<"laelia.v1.ListIdentityProvidersRequest"> & {
};
...
/**
 * @generated from message laelia.v1.ListIdentityProvidersResponse
 */
export declare type ListIdentityProvidersResponse = Message<"laelia.v1.ListIdentityProvidersResponse"> & {
  /**
   * The identity providers from the specified request.
   *
   * @generated from field: repeated laelia.v1.IdentityProvider identity_providers = 1;
   */
...
/**
 * @generated from message laelia.v1.CreateIdentityProviderRequest
 */
export declare type CreateIdentityProviderRequest = Message<"laelia.v1.CreateIdentityProviderRequest"> & {
  /**
   * The identity provider to create.
   *
   * @generated from field: laelia.v1.IdentityProvider identity_provider = 1;
   */
...
/**
 * @generated from message laelia.v1.UpdateIdentityProviderRequest
 */
export declare type UpdateIdentityProviderRequest = Message<"laelia.v1.UpdateIdentityProviderRequest"> & {
  /**
...
/**
 * @generated from message laelia.v1.DeleteIdentityProviderRequest
 */
export declare type DeleteIdentityProviderRequest = Message<"laelia.v1.DeleteIdentityProviderRequest"> & {
  /**
...
/**
 * @generated from message laelia.v1.TestIdentityProviderRequest
 */
export declare type TestIdentityProviderRequest = Message<"laelia.v1.TestIdentityProviderRequest"> & {
  /**
  ...
  /**
   * @generated from oneof laelia.v1.TestIdentityProviderRequest.context
   */
  context: {
    /**
     * @generated from field: laelia.v1.OAuth2IdentityProviderTestRequestContext oauth2_context = 2;
     */
     ...
     *
     * @generated from field: laelia.v1.OIDCIdentityProviderTestRequestContext oidc_context = 3;
     */
     ...
     *
     * @generated from field: laelia.v1.LDAPIdentityProviderTestRequestContext ldap_context = 4;
     */
...
/**
 * @generated from message laelia.v1.OAuth2IdentityProviderTestRequestContext
 */
export declare type OAuth2IdentityProviderTestRequestContext = Message<"laelia.v1.OAuth2IdentityProviderTestRequestContext"> & {
  /**
...
/**
 * @generated from message laelia.v1.OIDCIdentityProviderTestRequestContext
 */
export declare type OIDCIdentityProviderTestRequestContext = Message<"laelia.v1.OIDCIdentityProviderTestRequestContext"> & {
  /**
...
/**
 * @generated from message laelia.v1.LDAPIdentityProviderTestRequestContext
 */
export declare type LDAPIdentityProviderTestRequestContext = Message<"laelia.v1.LDAPIdentityProviderTestRequestContext"> & {
  /**
...
/**
 * @generated from message laelia.v1.TestIdentityProviderResponse
 */
export declare type TestIdentityProviderResponse = Message<"laelia.v1.TestIdentityProviderResponse"> & {
  /**
...
/**
 * @generated from message laelia.v1.IdentityProvider
 */
export declare type IdentityProvider = Message<"laelia.v1.IdentityProvider"> & {
  /**
   ...
   *
   * @generated from field: laelia.v1.IdentityProviderType type = 4;
   */
   ...
   *
   * @generated from field: laelia.v1.IdentityProviderConfig config = 5;
   */
...
/**
 * @generated from message laelia.v1.IdentityProviderConfig
 */
export declare type IdentityProviderConfig = Message<"laelia.v1.IdentityProviderConfig"> & {
  /**
   * @generated from oneof laelia.v1.IdentityProviderConfig.config
   */
  config: {
    /**
     * OAuth2 protocol configuration.
     *
     * @generated from field: laelia.v1.OAuth2IdentityProviderConfig oauth2_config = 1;
     */
     ...
     *
     * @generated from field: laelia.v1.OIDCIdentityProviderConfig oidc_config = 2;
     */
     ...
     *
     * @generated from field: laelia.v1.LDAPIdentityProviderConfig ldap_config = 3;
     */
 ...
 *
 * @generated from message laelia.v1.OAuth2IdentityProviderConfig
 */
export declare type OAuth2IdentityProviderConfig = Message<"laelia.v1.OAuth2IdentityProviderConfig"> & {
  /**
   ...
   *
   * @generated from field: laelia.v1.FieldMapping field_mapping = 7;
   */
   ...
   *
   * @generated from field: laelia.v1.OAuth2AuthStyle auth_style = 9;
   */
 ...
 *
 * @generated from message laelia.v1.OIDCIdentityProviderConfig
 */
export declare type OIDCIdentityProviderConfig = Message<"laelia.v1.OIDCIdentityProviderConfig"> & {
  /**
   ...
   *
   * @generated from field: laelia.v1.FieldMapping field_mapping = 5;
   */
  fieldMapping?: FieldMapping | undefined;
   ...
   * The authentication style for client credentials.
   *
   * @generated from field: laelia.v1.OAuth2AuthStyle auth_style = 7;
   */
  authStyle: OAuth2AuthStyle;
};
 ...
 *
 * @generated from message laelia.v1.LDAPIdentityProviderConfig
 */
export declare type LDAPIdentityProviderConfig = Message<"laelia.v1.LDAPIdentityProviderConfig"> & {
  /**
   ...
   *
   * @generated from field: laelia.v1.LDAPIdentityProviderConfig.SecurityProtocol security_protocol = 8;
   */
   ...
   * server.
   *
   * @generated from field: laelia.v1.FieldMapping field_mapping = 9;
   */
  fieldMapping?: FieldMapping | undefined;
};
 ...
 * `FieldMapping`.
 *
 * @generated from message laelia.v1.FieldMapping
 */
export declare type FieldMapping = Message<"laelia.v1.FieldMapping"> & {
  /**
...
export declare const IdentityProviderService: GenService<{
   ...
   *
   * @generated from rpc laelia.v1.IdentityProviderService.GetIdentityProvider
   */
  getIdentityProvider: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc laelia.v1.IdentityProviderService.ListIdentityProviders
   */
   ...
   *
   * @generated from rpc laelia.v1.IdentityProviderService.CreateIdentityProvider
   */
   ...
   *
   * @generated from rpc laelia.v1.IdentityProviderService.UpdateIdentityProvider
   */
   ...
   *
   * @generated from rpc laelia.v1.IdentityProviderService.DeleteIdentityProvider
   */
   ...
   * Permissions required: laelia.identityProviders.update
   *
   * @generated from rpc laelia.v1.IdentityProviderService.TestIdentityProvider
   */
