...
var file_v1_auth_service_proto_goTypes = []any{
	(*LoginRequest)(nil),                  // 0: laelia.v1.LoginRequest
	(*IdentityProviderContext)(nil),       // 1: laelia.v1.IdentityProviderContext
	(*OAuth2IdentityProviderContext)(nil), // 2: laelia.v1.OAuth2IdentityProviderContext
	(*LoginResponse)(nil),                 // 3: laelia.v1.LoginResponse
	(*LogoutRequest)(nil),                 // 4: laelia.v1.LogoutRequest
	(*User)(nil),                          // 5: laelia.v1.User
	(*emptypb.Empty)(nil),                 // 6: google.protobuf.Empty
}
var file_v1_auth_service_proto_depIdxs = []int32{
	1, // 0: laelia.v1.LoginRequest.idp_context:type_name -> laelia.v1.IdentityProviderContext
	2, // 1: laelia.v1.IdentityProviderContext.oauth2_context:type_name -> laelia.v1.OAuth2IdentityProviderContext
	5, // 2: laelia.v1.LoginResponse.user:type_name -> laelia.v1.User
	0, // 3: laelia.v1.AuthService.Login:input_type -> laelia.v1.LoginRequest
	4, // 4: laelia.v1.AuthService.Logout:input_type -> laelia.v1.LogoutRequest
	3, // 5: laelia.v1.AuthService.Login:output_type -> laelia.v1.LoginResponse
	6, // 6: laelia.v1.AuthService.Logout:output_type -> google.protobuf.Empty
