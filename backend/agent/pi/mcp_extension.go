...
// from LAELIA_MCP_PROXY_URL (injected by buildPiEnv), fetches the catalog at
// load time, and forwards tool calls to the daemon proxy.
const managedMcpExtensionTemplate = `export default function (pi: any) {
